...
test('lcr tests', async(t) => {
  ...
  try {
    ...
    execSync(`mysql -h 127.0.0.1 -u root --protocol=tcp -D jambones_test < ${__dirname}/db/${mysqlOpts.dialect}/jambones-sql.sql`);
    execSync(`mysql -h 127.0.0.1 -u root --protocol=tcp -D jambones_test < ${__dirname}/db/${mysqlOpts.dialect}/populate-test-data2.sql`);
